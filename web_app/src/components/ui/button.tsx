...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:opacity-50 gap-2",
  {
    variants: {
      variant: {
        default:
          "bg-primary-blue400 text-primary-foreground shadow hover:bg-primary-blue400/90 disabled:bg-primary-gray700 disabled:opacity-100 text-white",
        destructive:
        ...
        ghost: "hover:bg-accent disabled:bg-transparent hover:text-accent-foreground",
