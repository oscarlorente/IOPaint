...
function Home() {
  ...
  useEffect(() => {
    ...
    setParams({ bucketName, agencyId, userToken, tourId, imageId, imageName });
  }, [searchParams]);

  const userInputImage = getInputImage(params.bucketName, params.agencyId, params.userToken, params.tourId, params.imageId, params.imageName)
